...
def main():
    ...
    parser.add_argument("--input", type=str, default="/Users/haggai/shave/aura/scripts/proof_of_thought_timestamp_seal_template-gigapixel-high fidelity v2-2x.png", help="Path to input template image")
    ...
    base_with_emboss.save(args.output)
